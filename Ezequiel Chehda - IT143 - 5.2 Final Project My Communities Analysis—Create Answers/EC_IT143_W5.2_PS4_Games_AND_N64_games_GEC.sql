...
SELECT * FROM dbo.ps4_games
ORDER BY Developer_s;
...
--A: Compare the average and total sales of developers who appear in both the N64 and PS4 datasets. 
...
SELECT * FROM dbo.ps4_games
ORDER BY Publisher_s;

SELECT Publisher_s AS Publisher
	,	SUM(Copies_sold_int) AS Total_Sales
	,	AVG(Copies_sold_int) AS Average 
	,	COUNT(*) AS NumberOfGames
FROM dbo.ps4_games
